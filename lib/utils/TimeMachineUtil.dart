...
class TimeMachineUtil {
  ...
  /// get day of year.
  /// 在今年的第几周.
  static int getWeeksOfYear(DateTime dateTime) {
    int days = DateUtil.getDayOfYear(dateTime);
    DateTime firstDay = DateTime.parse('${dateTime.year}-01-01');
    int weekday = firstDay.weekday; //第一天是周几
    return (days + weekday - 2) ~/ 7 + 1;
  }
